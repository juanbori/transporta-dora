<template>
  <div class="pt-12 pb-16">
    ...
    <v-container fill-height>
      ...
      <div class="pt-12">
        <h3 class="text-left font-italic">{{ title }}</h3>
      ...
      <div>
        ...
        <v-row class="pt-6 pb-12" justify="space-between">
          <v-card class="ma-3" width="200px" v-for="comentario in comentarios" :key="comentario.persona">
            <v-card-text>
              <p class="h4 text--primary">{{`${comentario.persona} de ${comentario.lugar}`}}</p>
      ...
      comentarios: [
        {
          persona: "Oscar",
          lugar: "Flores",
          frase: "Muy buen trato y cumplen con todo. Los recomiendo!"
        },
        {
          persona: "Juan",
          lugar: "Microcentro",
        ...
        },
        {
          persona: "Melina",
          lugar: "Retiro",
          frase: "Puntuales y muy profesionales. Ya los recomendé a mis amigos"
        },
        {
          persona: "Silvia",
          lugar: "Caballito",
          frase: "Excelente servicio. Todo el personal muy amable"
        },
        {
          persona: "Matías",
          lugar: "Belgrano",
          frase: "Muy prolijos para el embalaje!"
        }
      ]
    };
  },
